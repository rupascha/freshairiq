...
def test_release_version_021002_everywhere():
    ...
    assert '"version": "0.25.0.54"' in (COMP / "manifest.json").read_text(encoding="utf-8")
    assert 'const FAIQ_VERSION = "0.25.0.54";' in JS
    assert 'Current release: 0.25.0.54' in (ROOT / "README.md").read_text(encoding="utf-8")
