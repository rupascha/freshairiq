...
def test_validation_prefers_time_aligned_objective_outcome_fields():
    ...
    record = build_validation_record({"started_at": "a", "ended_at": "b"}, [session], model_version="0.25.0.35")
...
def test_release_version_025027_is_consistent():
    ...
    assert '"version": "0.25.0.35"' in manifest
    assert 'const FAIQ_VERSION = "0.25.0.35";' in card
    assert '"version": "0.25.0.35"' in package
