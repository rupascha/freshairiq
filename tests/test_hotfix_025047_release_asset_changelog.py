"""Regression contracts for v0.25.1.6 release-asset/changelog hygiene."""
...
def test_release_metadata_is_025047_and_hygiene_named():
    ...
    assert package["version"] == "0.25.1.6"
    assert str(policy["release"]["artifact_suffix"]).strip()
    assert (ROOT / "docs" / "releases" / "RELEASE_NOTES_0.25.1.6.md").is_file()
