"""Regression contracts for v0.25.0.48 release-asset/changelog hygiene."""
...
def test_release_metadata_is_025047_and_hygiene_named():
    ...
    assert package["version"] == "0.25.0.48"
    assert policy["release"]["artifact_suffix"] == "Release-Asset-Changelog-Hygiene-Hotfix"
    assert (ROOT / "RELEASE_NOTES_0.25.0.48.md").is_file()
...
def test_mini_hotfix_does_not_touch_core_runtime_files_beyond_version_markers():
    ...
    assert '"version": "0.25.0.48"' in manifest
