"""Regression contracts for v0.25.0.47 release-asset/changelog hygiene."""
...
def test_release_metadata_is_025047_and_hygiene_named():
    ...
    assert manifest["version"] == "0.25.0.47"
    assert policy["version"] == "0.25.0.47"
    assert package["version"] == "0.25.0.47"
    assert policy["release"]["artifact_suffix"] == "Release-Asset-Changelog-Hygiene-Hotfix"
    assert (ROOT / "RELEASE_NOTES_0.25.0.47.md").is_file()
