...
def test_all_version_markers_match():
    ...
    assert 'const FAIQ_VERSION = "0.25.0.42";' in (COMP / "frontend/freshairiq-card.js").read_text(encoding="utf-8")
    assert "Current release: 0.25.0.42" in (ROOT / "README.md").read_text(encoding="utf-8")
