"""Regression contracts for v0.25.0.66 public-beta defaults and README assets."""
...
def test_public_beta_readme_and_screenshots_are_packaged():
    ...
    assert "Öffentliche Beta · Version 0.25.0.66" in readme
...
def test_release_versions_are_aligned():
    ...
    assert manifest["version"] == policy["version"] == package["version"] == "0.25.0.66"
