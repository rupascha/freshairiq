...
def test_release_version_022000_is_consistent():
    ...
    assert '"version": "0.25.1.6"' in (COMP / "manifest.json").read_text(encoding="utf-8")
    assert 'const FAIQ_VERSION = "0.25.1.6";' in (COMP / "frontend" / "freshairiq-card.js").read_text(encoding="utf-8")
