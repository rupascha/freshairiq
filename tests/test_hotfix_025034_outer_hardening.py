"""Regression contracts for v0.25.0.41 outer hardening hotfix."""
...
def test_transport_redacts_string_resident_names_but_preserves_version_fields() -> None:
    export = {
        ...
        "test_dossier": {
            ...
            "freshairiq_version_history": [{"version": "0.25.0.41", "record_count": 1}],
        },
        "records": [{
    ...
    assert metadata["freshairiq_version"] == "0.25.0.41"
    assert metadata["test_dossier"]["configuration"]["freshairiq_version"] == "0.25.0.41"
    assert metadata["test_dossier"]["freshairiq_version_history"][0]["version"] == "0.25.0.41"
    assert records[0]["freshairiq_version"] == "0.25.0.41"
