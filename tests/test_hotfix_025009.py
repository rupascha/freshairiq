...
def test_release_version_is_025009():
    ...
    assert json.loads((COMP / "manifest.json").read_text(encoding="utf-8"))["version"] == "0.25.0.65"
    for name in ("freshairiq-card.js", "freshairiq-panel.js", "freshairiq-loader.js"):
        assert 'const FAIQ_VERSION = "0.25.0.65";' in (COMP / "frontend" / name).read_text(encoding="utf-8")
