...
class FreshAirIQCard extends HTMLElement {
    ...
    constructor() { super(); this.attachShadow({ mode: "open" }); this._config = {}; this._pageScrollSnapshot = null; this._hass = null; this._dialogOpen = false; this._info = null; this._infoStack = []; this._dialogScrollTop = 0; this._subdialogScrollTop = 0; this._forceDialogTop = false; this._postResultTimer = null; this._settingsData = null; this._settingsLoading = false; this._settingsSaving = false; this._settingsError = null; this._settingsNotice = null; this._renderFrame = null; this._renderFrameIsRaf = false; this._liveRefreshFrame = null; this._liveRefreshFrameIsRaf = false; this._statusEntityId = null; this._statusRescanNeeded = false; this._relevantStateIds = null; this._roomEntityIds = null; this._roomConfigSignature = null; this._entityCache = {}; this._profileOverride = null; this._forecastOverride = null; this._fieldTestRegistrationPromise = null; this._fieldTestSessionClientId = null; this._liveViewSnapshot = null; this._liveHtmlCache = {}; this._chartCache = { bars: new WeakMap(), line: new WeakMap() }; this._learningCardCache = null; }
    ...
    _closeOverlayToCard() {
        this._dialogOpen = false; this._info = null; this._infoStack = []; this._subdialogScrollTop = 0;
    ...
    _render() {
        ...
        (_o = this.shadowRoot.getElementById("rooms")) === null || _o === void 0 ? void 0 : _o.addEventListener("click", e => { e.stopPropagation(); this._captureOverlayViewport(); clearTimeout(this._deferredRender); this._deferredRender = null; this._infoStack = []; this._subdialogScrollTop = 0; this._info = "rooms"; this._render(); });
        (_p = this.shadowRoot.getElementById("guests")) === null || _p === void 0 ? void 0 : _p.addEventListener("click", e => { e.stopPropagation(); this._captureOverlayViewport(); this._infoStack = []; this._subdialogScrollTop = 0; this._info = "guests"; this._render(); });
        ...
        (_s = this.shadowRoot.getElementById("info-close")) === null || _s === void 0 ? void 0 : _s.addEventListener("click", e => { e.stopPropagation(); this._info = null; this._infoStack = []; this._subdialogScrollTop = 0; this._render(); this._restoreOverlayViewport(); });
