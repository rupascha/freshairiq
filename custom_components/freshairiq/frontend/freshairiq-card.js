...
/* v0.25.1.6 Compact AI-first dashboard. The full analysis remains behind the
...
class FreshAirIQCard extends HTMLElement {
    ...
    _compactAIPanel(st, rooms = []) {
        ...
        const kind = active.length ? "live"
            ...
            : "good";
        const color = kind === "sensor" ? "#ff7770" : ["close", "wait", "pollen"].includes(kind) ? "#ffb45f" : ["good", "success", "recommend"].includes(kind) ? "#62e889" : ["live", "cooling"].includes(kind) ? "#63d2f7" : (hero.color || "#63d2f7");
        ...
        return `<section class="ai-compact ${kind}" style="--ai:${color}">
          <div class="ai-assistant clickable" data-info="decision">
            <div class="ai-mascot" aria-hidden="true"><span class="ai-smile"></span><span class="ai-leaf"></span></div>
