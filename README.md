...
## Current release: 0.25.0.41 – GitHub Release Gate
...
Published GitHub releases are the update source. Each release tag must match the version in `custom_components/freshairiq/manifest.json` (for example `v0.25.0.41` for manifest version `0.25.0.41`). Repository-owner and beta-tester instructions are documented in `HACS_BETA_SETUP.md`.
